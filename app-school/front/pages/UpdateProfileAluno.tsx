...
interface UpdateProfileAlunoProps {
  navigation: any;
}

const UpdateProfileAluno: React.FC<UpdateProfileAlunoProps> = ({ navigation }) => {
  ...
  const validateForm = () => {
    ...
    if (!userData.matricula || userData.matricula.trim().length === 0) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const response = await alunoService.update(updateData);
...
export default UpdateProfileAluno;